<div>
    ...
    <div id="alert-student" class="mt-3 flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
      <div class="ms-3 text-sm font-medium">
        <span class="font-medium">{{ session('success_department') }}</span> 
      </div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 flex">
                    <x-edit-modal-button class="mr-1" wire:click="editUser({{ $department->id }})"
                        x-data=""
                        x-on:click.prevent="$dispatch('open-modal', 'edit-course-modal-{{ $department->id }}')"
                    >{{ __('Edit') }}
                    </x-edit-modal-button> 

                    <form wire:submit.prevent="archive({{ $department->id }})" class="ml-1">
        ...
        <tbody>
          @foreach ($subdepartments as $subdepartment)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="px-6 py-4 flex">
                  <x-edit-modal-button class="mr-1" wire:click="editUser({{ $subdepartment->id }})"
                      x-data=""
                      x-on:click.prevent="$dispatch('open-modal', 'edit-course-modal-{{ $subdepartment->id }}')"
                  >{{ __('Edit') }}
                  </x-edit-modal-button> 

                  <form wire:submit.prevent="archive({{ $subdepartment->id }})" class="ml-1">
                      <x-archive-modal-button>Delete</x-archive-modal-button> 
                  </form>
              </td>
            </tr>
